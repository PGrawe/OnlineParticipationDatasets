...
class RaddialogMoersSpider(scrapy.Spider):
    name = "raddialog-moers"
    start_urls = ['https://www.raddialog.moers.de/node/1384?sort_bef_combine=created%20ASC']

    def __init__(self, *args, **kwargs):
        super(RaddialogMoersSpider, self).__init__(*args, **kwargs)
