...
class RaddialogKoelnSpider(scrapy.Spider):
    name = "raddialog-koeln"
    start_urls = ['http://www.raddialog-ehrenfeld.koeln/dialoge/ehrenfelder-raddialog?sort_bef_combine=created%20ASC']

    def __init__(self, *args, **kwargs):
        super(RaddialogKoelnSpider, self).__init__(*args, **kwargs)
