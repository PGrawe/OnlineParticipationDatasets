...
class Koeln2015Spider(scrapy.Spider):
    ...
    def parse_comment_tree(self, item_list):
        """
        Parse list with Comments, see :class:`~OnlineParticipationDatasetsitems.Comment`, to restore the comment tree. Write parent and children to items. Items need to have values for level, comment_id and suggestion_id.

        :param item_list: list with Comments
        :return list with Comments
        """
        stack = []
